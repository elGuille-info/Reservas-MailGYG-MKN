...
namespace ReservasGYG_Movil
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async Task<bool> EnviarMensajeConfirmacion()
        {
            ...
            #region Quitado para usar el código del delegado (18/sep/23 15.55)
            ...
            // Parece que no va así.                        (18/sep/23 17.59)
            //// Usar MailGYG.TextoMensajeConfirmacion        (18/sep/23 10.31)
            //var retMSG = MailGYG.TextoMensajeConfirmacion(re, delegado: AccederRecurso);
            //sb.Append(retMSG.Body);
            //LabelAsuntoEmail.Text = retMSG.Asunto;
        ...
        /// <summary>
        /// Función para acceder a los ficheros de recursos de la app móvil.
        /// </summary>
        /// <param name="recurso"></param>
        /// <returns>La cadena del recurso indicado.</returns>
        private async Task<string> AccederRecurso(string recurso)
        {
            return await MainPage.LeerAsset(recurso);
        }
